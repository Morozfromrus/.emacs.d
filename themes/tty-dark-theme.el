...
(custom-theme-set-faces
 ...
 '(font-lock-variable-name-face ((t (:foreground "#2222ff"))))
 ...
 '(message-header-xheader-face ((t (:foreground "#2222ff"))))
 '(message-mml-face ((t (:foreground "green"))))
 '(message-separator-face ((t (:foreground "#2222ff"))))

 '(modeline ((t (:background "white" :foreground "#2222ff"))))
